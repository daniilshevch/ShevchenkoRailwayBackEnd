...
public class TrainRouteOnDateArrivalDepartureTimeDto
{
    ...
    public TrainRouteOnDateOnStation Route_Starting_Stop { get; set; } = null!;
    public TrainRouteOnDateOnStation Route_Ending_Stop { get; set; } = null!;
...
namespace RailwayCore.Services
{
    public class FullTrainRouteSearchService
    {
        ...
        public async Task<List<PassengerCarriageOnTrainRouteOnDate>?> GetPassengerCarriageAssignementsForSeveralTrainRoutesOnDate(List<string> train_route_on_date_ids_list)
        {
            //TrainRouteOnDate? train_route_on_date = await train_route_on_date_service.FindTrainRouteOnDateById(train_route_on_date_id);
        ...
        public async Task<List<PassengerCarriageOnTrainRouteOnDate>?> GetPassengerCarriageAssignementsForTrainRouteOnDate(string train_route_id, DateOnly departure_date)
        {
            string train_route_on_date_id = train_route_on_date_service.BuildTrainRouteOnDateIdentificator(train_route_id, departure_date);
            return await GetPassengerCarriageAssignementsForTrainRouteOnDate(train_route_on_date_id);
        }
