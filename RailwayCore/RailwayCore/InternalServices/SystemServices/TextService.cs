...
namespace RailwayCore.Services
{
    ...
    public class TextService
    {
        ...
        public void SuccessPostInform(string message)
        {
            ...
            {
                Console.WriteLine($"{Green}[{ServiceTitle}]{Reset}{Orange}[POST]{Reset}" +
                    $" {message}");
            }
        }
        public void SuccessGetInform(string message)
        {
            ...
            {
                Console.WriteLine($"{Green}[{ServiceTitle}]{Reset}{Orange}[GET]{Reset}" +
                    $" {message}");
            }
        }
        public void FailPostInform(string message)
        {
            if (FailPostEnabled)
            {
                Console.WriteLine($"{Red}[{ServiceTitle}]{Reset}{Orange}[POST]{Reset}" +
                    $" {message}");
            }
        }
        public void FailGetInform(string message)
        {
            if (FailGetEnabled)
            {
                Console.WriteLine($"{BrightRed}[{ServiceTitle}]{Reset}{Orange}[GET]{Reset}" +
                    $" {message}");
            }
        }
        public void DuplicateGetInform(string message)
        {
            if (DuplicateEnabled)
            {
                Console.WriteLine($"{Yellow}[{ServiceTitle}]{Reset}{Orange}[POST]{Reset}" +
                    $" {message}");
            }
        }
