...
namespace RailwayCore.Migrations
{
    ...
    [Migration("20250211132735_PassengerCarrigeOnTrainRouteOnDateRemake")]
    partial class PassengerCarrigeOnTrainRouteOnDateRemake
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RailwayCore.Models.PassengerCarriage", b =>
                {
                    ...
                    b.Property<string>("Renewal_Performer")
                        .HasMaxLength(30)
                        .HasColumnType("varchar(30)");
            ...
            modelBuilder.Entity("RailwayCore.Models.PassengerCarriageOnTrainRouteOnDate", b =>
                {
                    ...
                    b.Property<bool>("Factural_Is_Inclusive")
                        .HasColumnType("tinyint(1)");
